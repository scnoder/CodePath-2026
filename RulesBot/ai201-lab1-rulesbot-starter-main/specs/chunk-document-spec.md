...
```
There are 149 total chunks where Catan has 18 chunks. Clue has 21 chunks. Codenames has 16 chunks. Monopoly has 23 chunks. Pandemic has 18 chunks. Risk has 20 chunks. Ticket To Ride has 16 chunks. Uno has 17 chunks.
```

**One thing that surprised you or didn't match your expectations:**

```
I didn't realize that creating and implementing the documents would be so complicated.
```
