...
I didn't use Claude for added the functions and implementing them into `agent.py` It was not very difficult. However, implementing it all into the loop took some work so I used AI because I ran into logic errors. I gave it the code I already had which was a lot of the TODO list logic and told it to turn it into a loop.
